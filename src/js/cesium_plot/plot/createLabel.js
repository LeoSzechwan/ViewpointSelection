...
class CreateLabel extends BasePlot {
  ...
  setStyle(style) {
    ...
    if (style.font) {
      this.entity.label.font = style.font;
    }
  ...
  getStyle() {
    ...
    if (label.font) obj.font = label.font.getValue();
  ...
  createLabel(cartesian) {
    ...
    let label = this.viewer.entities.add({
      ...
      label: {
        ...
        pixelOffset: new Cesium.Cartesian2(0, 0 - this.style.fontSize * 0.75),
        ...
        font: this.style.fontSize ? this.style.fontSize + 'px sans-serif' : '16px sans-serif',
