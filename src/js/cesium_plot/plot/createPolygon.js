...
class CreatePolygon extends BasePlot {
	...
	setStyle(style) {
		...
		if(style.outline){
			...
			this.polyline.clampToGround = style.clampToGround;
		...
		if (style.heightReference == 0 || style.clampToGround) { this.entity.polygon.heightReference = Cesium.HeightReference.CLAMP_TO_GROUND }
		else { this.entity.polygon.heightReference = Number(style.heightReference) };
	...
	createPolygon() {
		...
		let polygonObj = {
			polygon: {
				...
				heightReference: this.style.heightReference || Cesium.HeightReference.CLAMP_TO_GROUND,
				show: true,
	...
	createPolyline() {
		...
		return this.dataSource.entities.add({
			polyline: {
				...
				clampToGround: this.style.clampToGround || Boolean(this.style.heightReference),
